...
int16_t Avionics::compressData() {
  ...
  lengthBits += compressVariable(filter.current_rb.avg,                      0,    1023,    8,  lengthBits);
  lengthBits += compressVariable(filter.current_rb.max,                      0,    1023,    8,  lengthBits);
  ...
  lengthBits += compressVariable(filter.current_payload.avg,                 0,    1023,    8,  lengthBits);
  lengthBits += compressVariable(filter.current_payload.max,                 0,    1023,    8,  lengthBits);
