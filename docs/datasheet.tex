...
\begin{center}\includegraphics[width=0.6\linewidth]{render.jpg}\end{center}
\begin{center}\includegraphics[width=\linewidth]{trajfig.png}\end{center}
