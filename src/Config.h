...
static const char      CSV_DATA_HEADER[]                     =         "TIME,LAT_GPS,LONG_GPS,ALTITUDE,ALTITUDE_GPS,ASCENT_RATE,VALVE_INCENTIVE,BALLAST_INCENTIVE,VALVE_STATE,BALLAST_STATE,VALVE_QUEUE,BALLAST_QUEUE,NUM_VALVES,NUM_BALLASTS,NUM_VALVE_ATTEMPTS,NUM_BALLAST_ATTEMPTS,NUM_BALLAST_OVER_CURRENTS,CUTDOWN_STATE,TEMP_IN,JOULES,VOLTAGE,CURRENT_AVG,CURRENT_MIN,CURRENT_MAX,CURRENT_GPS_AVG,CURRENT_GPS_MAX,CURRENT_RB_AVG,CURRENT_RB_MAX,CURRENT_MOTORS_AVG,CURRENT_MOTORS_MAX,CURRENT_PAYLOAD_AVG,CURRENT_PAYLOAD_MAX,TEMP_EXT,LOOP_TIME,RB_SENT_COMMS,EULER_X_AVG,EULER_Y_AVG,EULER_Z_AVG,MANUAL_MODE,REPORT_MODE,SHOULD_REPORT,RB_SHOULD_USE,GPS_SHOULD_USE,HEATER_SHOULD_USE,PAYLOAD_SHOULD_USE,HEATER_STRONG_ENABLE,HEATER_WEEK_ENABLE,GPS_GOOD_STATE,SPEED_GPS,HEADING_GPS,NUM_SATS_GPS,INCENTIVE_NOISE,RE_ARM_CONSTANT,VALVE_ALT_LAST,BALLAST_ALT_LAST,SHOULD_LED,DEBUG_STATE,FORCE_VALVE,FORCE_BALLAST,BMP_1_ENABLE,BMP_2_ENABLE,BMP_3_ENABLE,BMP_4_ENABLE,BMP_1_REJECTIONS,BMP_2_REJECTIONS,BMP_3_REJECTIONS,BMP_4_REJECTIONS,TEMP_SETPOINT,COMMS_INTERVAL,GPS_INTERVAL,PRESS_BASELINE,INCENTIVE_THRESHOLD,BALLAST_ARM_ALT,BALLAST_REVERSE_TIMEOUT,BALLAST_STALL_CURRENT,VALVE_MOTOR_SPEED,BALLAST_MOTOR_SPEED,VALVE_OPENING_TIMEOUT,VALVE_CLOSING_TIMEOUT,VALVE_SETPOINT,VALVE_DURATION,VALVE_FORCE_DURATION,VALVE_VELOCITY_CONSTANT,VALVE_ALTITUDE_DIFF_CONSTANT,VALVE_LAST_ACTION_CONSTANT,BALLAST_SETPOINT,BALLAST_DURATION,BALLAST_FORCE_DURATION,BALLAST_VELOCITY_CONSTANT,BALLAST_ALTITUDE_DIFF_CONSTANT,BALLAST_LAST_ACTION_CONSTANT,EULER_HISTORY,SETUP_STATE,SHOULD_CUTDOWN,RAW_TEMP_1,RAW_TEMP_2,RAW_TEMP_3,RAW_TEMP_4,RAW_PRESSURE_1,RAW_PRESSURE_2,RAW_PRESSURE_3,RAW_PRESSURE_4,PRESS,CURRENT,CURRENT_GPS,CURRENT_RB,CURRENT_MOTORS,CURRENT_PAYLOAD,EULER_X,EULER_Y,EULER_Z,GPS_LAST,COMMS_LAST,COMMS_LENGTH,DATAFILE_LAST";
