...
\noindent ValBal is SSI's in-house developed HAB platform, designed to facilitate a broad range of high altitude research through highly dynamic altitude control. ValBal can extend the endurance of a latex balloon from a few hours to a record-breaking 5 days, and can maintain and dynamically transition between altitudes all the way from ground level to it flight ceiling. These capabilities, along with its low cost, make it ideally suited for a variety of previously challenging mission profiles.
...
\section*{\sffamily Key specifications}
\vspace{1ex}
...
\end{tabular}
\end{center}
{\footnotesize \textbf{\small Notes:}
...
\paragraph{\sffamily Range of applications:} \Blindtext[1][5]
}
