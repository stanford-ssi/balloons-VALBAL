...
/*
 * Further jankified for use with ValBal
 * Took out a lot of stuff, so if you want to use thise for other things in the future,
 * look at a diff with the original, and goodluck
 *
 * - John Bean
 */
