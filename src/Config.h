...
static const char      CSV_DATA_HEADER[]             =    "TIME,LAT_GPS,LONG_GPS,ALTITUDE,ALTITUDE_GPS,ASCENT_RATE,VALVE_INCENTIVE,BALLAST_INCENTIVE,VALVE_STATE,BALLAST_STATE,NUM_VALVES,NUM_BALLASTS,CUTDOWN_STATE,PRESS,TEMP,JOULES,VOLTAGE,CURRENT,CURRENT_GPS,CURRENT_RB,CURRENT_MOTORS,CURRENT_PAYLOAD,TEMP_NECK,SPEED_GPS,HEADING_GPS,NUM_SATS_GPS,LOOP_TIME,RB_SENT_COMMS,COMMS_INTERVAL,GPS_INTERVAL,TEMP_SETPOINT,MANUAL_MODE,RB_SHOULD_USE,GPS_SHOULD_USE,HEATER_SHOULD_USE,HEATER_STRONG_ENABLE,HEATER_WEEK_ENABLE,BAT_GOOD_STATE,CURR_GOOD_STATE,PRES_GOOD_STATE,TEMP_GOOD_STATE,RB_GOOD_STATE,GPS_GOOD_STATE,PRESS_BASELINE,DO_NOTHING_INTERVAL,INCENTIVE_THRESHOLD,RE_ARM_CONSTANT,BALLAST_ARM_ALT,VALVE_SETPOINT,VALVE_DURATION,VALVE_ALT_LAST,VALVE_VELOCITY_CONSTANT,VALVE_ALTITUDE_DIFF_CONSTANT,VALVE_LAST_ACTION_CONSTANT,BALLAST_SETPOINT,BALLAST_DURATION,BALLAST_ALT_LAST,BALLAST_VELOCITY_CONSTANT,BALLAST_ALTITUDE_DIFF_CONSTANT,BALLAST_LAST_ACTION_CONSTANT,BMP_1_ENABLE,BMP_2_ENABLE,BMP_3_ENABLE,BMP_4_ENABLE,SHOULD_CUTDOWN,SHOULD_LED,SETUP_STATE,DEBUG_STATE,FORCE_VALVE,FORCE_BALLAST,REPORT_MODE,ALTITUDE_LAST,GPS_LAST,COMMS_LAST,COMMS_LENGTH,RAW_TEMP_1,RAW_TEMP_2,RAW_TEMP_3,RAW_TEMP_4,RAW_PRESSURE_1,RAW_PRESSURE_2,RAW_PRESSURE_3,RAW_PRESSURE_4,ALTITUDE_1,ALTITUDE_2,ALTITUDE_3,ALTITUDE_4";
