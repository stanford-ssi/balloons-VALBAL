...
static const uint8_t   BOOST_VOLTAGE                         =              A11;
static const uint8_t   USB_CURRENT                           =              A10;
...
static const char      CSV_DATA_HEADER[]                     =         "data.TIME,LAT_GPS,LONG_GPS,ALTITUDE_BAROMETER,ALTITUDE_GPS,ASCENT_RATE,VALVE_INCENTIVE,BALLAST_INCENTIVE,VALVE_STATE,BALLAST_STATE,VALVE_QUEUE,BALLAST_QUEUE,VALVE_TIME_TOTAL,BALLAST_TIME_TOTAL,VALVE_NUM_ACTIONS,BALLAST_NUM_ACTIONS,VALVE_NUM_ATTEMPTS,BALLAST_NUM_ATTEMPTS,BALLAST_NUM_OVERCURRENTS,CUTDOWN_STATE,TEMP_INT,JOULES_TOTAL,VOLTAGE_PRIMARY,VOLTAGE_5V,CURRENT_TOTAL_AVG,CURRENT_TOTAL_MIN,CURRENT_TOTAL_MAX,CURRENT_RB_AVG,CURRENT_RB_MAX,CURRENT_MOTOR_VALVE_AVG,CURRENT_MOTOR_VALVE_MAX,CURRENT_MOTOR_BALLAST_AVG,CURRENT_MOTOR_BALLAST_MAX,CURRENT_PAYLOAD_AVG,CURRENT_PAYLOAD_MAX,TEMP_EXT,LOOP_TIME_MAX,RB_SENT_COMMS,RB_SLEEP_FAILS,MANUAL_MODE,REPORT_MODE,SHOULD_REPORT,POWER_STATE_LED,POWER_STATE_RB,POWER_STATE_GPS,POWER_STATE_HEATER,POWER_STATE_PAYLOAD,HEATER_STRONG_ENABLE,HEATER_WEEK_ENABLE,NUM_SATS_GPS,SPEED_GPS,HEADING_GPS,INCENTIVE_NOISE,RE_ARM_CONSTANT,VALVE_ALT_LAST,BALLAST_ALT_LAST,DEBUG_STATE,FORCE_VALVE,FORCE_BALLAST,BMP_1_ENABLE,BMP_2_ENABLE,BMP_3_ENABLE,BMP_4_ENABLE,BMP_1_REJECTIONS,BMP_2_REJECTIONS,BMP_3_REJECTIONS,BMP_4_REJECTIONS,BLACK_BODY_TEMP,JOULES_HEATER,TEMP_SETPOINT,RB_INTERVAL,GPS_INTERVAL,RB_SHOULD_SLEEP,PRESS_BASELINE,INCENTIVE_THRESHOLD,BALLAST_ARM_ALT,BALLAST_REVERSE_INTERVAL,VALVE_LEAK_INTERVAL,BALLAST_STALL_CURRENT,VALVE_MOTOR_SPEED,BALLAST_MOTOR_SPEED,VALVE_OPENING_DURATION,VALVE_CLOSING_DURATION,VALVE_SETPOINT,VALVE_VENT_DURATION,VALVE_FORCE_DURATION,VALVE_VELOCITY_CONSTANT,VALVE_ALTITUDE_DIFF_CONSTANT,VALVE_LAST_ACTION_CONSTANT,BALLAST_SETPOINT,BALLAST_DROP_DURATION,BALLAST_FORCE_DURATION,BALLAST_VELOCITY_CONSTANT,BALLAST_ALTITUDE_DIFF_CONSTANT,BALLAST_LAST_ACTION_CONSTANT,SETUP_STATE,SHOULD_CUTDOWN,LOOP_TIME,RAW_TEMP_1,RAW_TEMP_2,RAW_TEMP_3,RAW_TEMP_4,RAW_PRESSURE_1,RAW_PRESSURE_2,RAW_PRESSURE_3,RAW_PRESSURE_4,PRESS,CURRENT_USB,CURRENT_TOTAL,CURRENT_RB,CURRENT_MOTOR_VALVE,CURRENT_MOTOR_BALLAST,CURRENT_PAYLOAD,PAYLOAD_MESSAGE_SIZE,PID_OUTPUT,GPS_LAST,RB_LAST,DATAFILE_LAST,COMMS_LENGTH,";
...
static const bool      RB_SHOULD_SLEEP_DEFAULT               =             true;
