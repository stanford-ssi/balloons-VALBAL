...
#       Serial.print(',');
#       Serial.print(simulated.LAT_GPS, 4);
#       Serial.print(',');
#       Serial.print(simulated.LONG_GPS, 4);
#       Serial.print(',');
#       Serial.print(simulated.ALTITUDE);
#       Serial.print(',');
#       Serial.print(simulated.ALTITUDE_GPS);
#       Serial.print(',');
#       Serial.print(simulated.ASCENT_RATE);
#       Serial.print(',');
#       Serial.print(simulated.VALVE_INCENTIVE);
#       Serial.print(',');
#       Serial.print(simulated.BALLAST_INCENTIVE);
#       Serial.print(',');
#       Serial.print(simulated.VALVE_STATE);
#       Serial.print(',');
#       Serial.print(simulated.BALLAST_STATE);
#       Serial.print(',');
#       Serial.print(simulated.VALVE_QUEUE);
#       Serial.print(',');
#       Serial.print(simulated.BALLAST_QUEUE);
#       Serial.print(',');
#       Serial.print(simulated.NUM_VALVES);
#       Serial.print(',');
#       Serial.print(simulated.NUM_BALLASTS);
#       Serial.print(',');
#       Serial.print(simulated.NUM_VALVE_ATTEMPTS);
#       Serial.print(',');
#       Serial.print(simulated.NUM_BALLAST_ATTEMPTS);
#       Serial.print(',');
#       Serial.print(simulated.CUTDOWN_STATE);
#       Serial.print(',');
#       Serial.print(simulated.PRESS);
#       Serial.print(',');
#       Serial.print(simulated.TEMP);
#       Serial.print(',');
#       Serial.print(simulated.JOULES);
#       Serial.print(',');
#       Serial.print(simulated.VOLTAGE);
#       Serial.print(',');
#       Serial.print(simulated.CURRENT);
#       Serial.print(',');
#       Serial.print(simulated.CURRENT_GPS);
#       Serial.print(',');
#       Serial.print(simulated.CURRENT_RB);
#       Serial.print(',');
#       Serial.print(simulated.CURRENT_MOTORS);
#       Serial.print(',');
#       Serial.print(simulated.CURRENT_PAYLOAD);
#       Serial.print(',');
#       Serial.print(simulated.TEMP_NECK);
#       Serial.print(',');
#       Serial.print(simulated.SPEED_GPS);
#       Serial.print(',');
#       Serial.print(simulated.HEADING_GPS);
#       Serial.print(',');
#       Serial.print(simulated.NUM_SATS_GPS);
#       Serial.print(',');
#       Serial.print(simulated.LOOP_TIME);
#       Serial.print(',');
#       Serial.print(simulated.RB_SENT_COMMS);
#       Serial.print(',');
#       Serial.print(simulated.COMMS_INTERVAL);
#       Serial.print(',');
#       Serial.print(simulated.GPS_INTERVAL);
#       Serial.print(',');
#       Serial.print(simulated.TEMP_SETPOINT);
#       Serial.print(',');
#       Serial.print(simulated.MANUAL_MODE);
#       Serial.print(',');
#       Serial.print(simulated.RB_SHOULD_USE);
#       Serial.print(',');
#       Serial.print(simulated.GPS_SHOULD_USE);
#       Serial.print(',');
#       Serial.print(simulated.HEATER_SHOULD_USE);
#       Serial.print(',');
#       Serial.print(simulated.HEATER_STRONG_ENABLE);
#       Serial.print(',');
#       Serial.print(simulated.HEATER_WEEK_ENABLE);
#       Serial.print(',');
#       Serial.print(simulated.BAT_GOOD_STATE);
#       Serial.print(',');
#       Serial.print(simulated.CURR_GOOD_STATE);
#       Serial.print(',');
#       Serial.print(simulated.PRES_GOOD_STATE);
#       Serial.print(',');
#       Serial.print(simulated.TEMP_GOOD_STATE);
#       Serial.print(',');
#       Serial.print(simulated.RB_GOOD_STATE);
#       Serial.print(',');
#       Serial.print(simulated.GPS_GOOD_STATE);
#       Serial.print(',');
#       Serial.print(simulated.PRESS_BASELINE);
#       Serial.print(',');
#       Serial.print(simulated.INCENTIVE_NOISE);
#       Serial.print(',');
#       Serial.print(simulated.INCENTIVE_THRESHOLD);
#       Serial.print(',');
#       Serial.print(simulated.RE_ARM_CONSTANT);
#       Serial.print(',');
#       Serial.print(simulated.BALLAST_ARM_ALT);
#       Serial.print(',');
#       Serial.print(simulated.VALVE_SETPOINT);
#       Serial.print(',');
#       Serial.print(simulated.VALVE_DURATION);
#       Serial.print(',');
#       Serial.print(simulated.VALVE_ALT_LAST);
#       Serial.print(',');
#       Serial.print(simulated.VALVE_VELOCITY_CONSTANT);
#       Serial.print(',');
#       Serial.print(simulated.VALVE_ALTITUDE_DIFF_CONSTANT);
#       Serial.print(',');
#       Serial.print(simulated.VALVE_LAST_ACTION_CONSTANT);
#       Serial.print(',');
#       Serial.print(simulated.BALLAST_SETPOINT);
#       Serial.print(',');
#       Serial.print(simulated.BALLAST_DURATION);
#       Serial.print(',');
#       Serial.print(simulated.BALLAST_ALT_LAST);
#       Serial.print(',');
#       Serial.print(simulated.BALLAST_VELOCITY_CONSTANT);
#       Serial.print(',');
#       Serial.print(simulated.BALLAST_ALTITUDE_DIFF_CONSTANT);
#       Serial.print(',');
#       Serial.print(simulated.BALLAST_LAST_ACTION_CONSTANT);
#       Serial.print(',');
#       Serial.print(simulated.SHOULD_CUTDOWN);
#       Serial.print(',');
#       Serial.print(simulated.SHOULD_LED);
#       Serial.print(',');
#       Serial.print(simulated.SETUP_STATE);
#       Serial.print(',');
#       Serial.print(simulated.DEBUG_STATE);
#       Serial.print(',');
#       Serial.print(simulated.FORCE_VALVE);
#       Serial.print(',');
#       Serial.print(simulated.FORCE_BALLAST);
#       Serial.print(',');
#       Serial.print(simulated.REPORT_MODE);
#       Serial.print(',');
#       Serial.print(simulated.BMP_1_ENABLE);
#       Serial.print(',');
#       Serial.print(simulated.BMP_2_ENABLE);
#       Serial.print(',');
#       Serial.print(simulated.BMP_3_ENABLE);
#       Serial.print(',');
#       Serial.print(simulated.BMP_4_ENABLE);
#       Serial.print(',');
#       Serial.print(simulated.RAW_TEMP_1);
#       Serial.print(',');
#       Serial.print(simulated.RAW_TEMP_2);
#       Serial.print(',');
#       Serial.print(simulated.RAW_TEMP_3);
#       Serial.print(',');
#       Serial.print(simulated.RAW_TEMP_4);
#       Serial.print(',');
#       Serial.print(simulated.RAW_PRESSURE_1);
#       Serial.print(',');
#       Serial.print(simulated.RAW_PRESSURE_2);
#       Serial.print(',');
#       Serial.print(simulated.RAW_PRESSURE_3);
#       Serial.print(',');
#       Serial.print(simulated.RAW_PRESSURE_4);
#       Serial.print(',');
#       Serial.print(simulated.ALTITUDE_LAST);
#       Serial.print(',');
#       Serial.print(simulated.GPS_LAST);
#       Serial.print(',');
#       Serial.print(simulated.COMMS_LAST);
#       Serial.print(',');
#       Serial.print(simulated.COMMS_LENGTH);
#       Serial.print('\n');
#     }
#   }
# }
